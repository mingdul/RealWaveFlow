...
2. **필수 환경 변수**
   ...
   - `AWS_ACCESS_KEY_ID_FOR_GITACTIONS`, `AWS_SECRET_ACCESS_KEY_FOR_GITACTIONS`: AWS S3 설정
...
- `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`: Google OAuth
- `AWS_ACCESS_KEY_ID_FOR_GITACTIONS`, `AWS_SECRET_ACCESS_KEY_FOR_GITACTIONS`: AWS 설정
